package com.qtctek.aladin.presenter.new_post;

import android.util.Log;

import com.qtctek.aladin.dto.Product;
import com.qtctek.aladin.model.new_post.ModelNewPost;
...
public class PresenterNewPost  implements PresenterImpHandleModelNewPost{
    ...
    public void handleDeleteFile(String linkImage, int productId){
