package com.qtctek.realstate.common.general.send_gmail;
...
public class GMailSender extends javax.mail.Authenticator  {
    ...
    static {
        Security.addProvider(new com.qtctek.realstate.common.general.send_gmail.JSSEProvider());
    }
...
//        the main thread. Use below code in your onViewCreated to avoid this error
//        else Call your networking operations (getting data from web server) request in thread
//        or Asynch class.
